...
class Document {
  ...
  List<String> getKeys() {
    if (internalState != null) {
      return internalState!.keys as List<String>;
    } else {
      return [];
    }
  }
  ...
  List<T> getList<T>(String key) {
    List<dynamic>? _result = getValue(key) as List<dynamic>?;
    if (_result != null) {
  ...
  Map<K, V> getMap<K, V>(String key) {
    Map<dynamic, dynamic>? _result = getValue(key) as Map<dynamic, dynamic>?;
    if (_result != null) {
